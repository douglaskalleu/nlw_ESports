...
app.get('/games/:id/ads', async (request, response) => {
  ...
  return response.json(ads.map(ad =>{
    return {
      ...
      hourStatr: convertMinutesToHoursString(ad.hourStatr),
      hourEnd: convertMinutesToHoursString(ad.hourStatr),
    }
  }))
})
...
app.post('/games/:id/ads', async (request, response) => {
  ...
  const ad = await prisma.ad.create({
    data: {
      ...
      hourStatr: convertHoursStringToMinutes(body.hourStatr),
